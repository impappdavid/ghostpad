    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogTrigger asChild>
                <div className="font-body px-3 py-1.5 text-sm  bg-[#ab9ff2c9] cursor-pointer  hover:bg-[#ab9ff2c1] rounded-xl transition-all flex items-center">
                    Get started
                </div>
            </DialogTrigger>
            <DialogContent className="sm:max-w-[425px] rounded-xl">
                <DialogHeader className="text-center">
                    ...
                    <DialogDescription className="text-center">Create an account to get started.</DialogDescription>
                </DialogHeader>
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="flex flex-col gap-4">
                        <Button type="submit" className="w-full rounded-xl" disabled={!acceptPolicy}>
                            Create Account
                        </Button>
                        <div className="text-center text-sm">
                            Already have an account?{" "}
                            <button type="button" className="text-primary underline font-medium" onClick={onLoginClick}>
                                Login
                            </button>
                        </div>
                    </div>
